...
export class MediaClientError extends Schema.Error<MediaClientError>(
  'MediaClientError',
)({
...
const responseMessage = Effect.fn('MediaClient.responseMessage')(function* (
  response: Response,
) {
...
export const uploadMedia = (
  ...
  Effect.runPromise(uploadMediaEffect(blob, kind, signal));
...
export const downloadMedia = (
  ...
  Effect.runPromise(downloadMediaEffect(mediaId, kind, signal));
