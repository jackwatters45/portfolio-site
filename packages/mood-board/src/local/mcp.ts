...
export const mcpLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    ...
    for (const action of actions) {
      ...
      const services = yield* Effect.context<Moodboards>();
