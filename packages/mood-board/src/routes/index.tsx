    ...
    <main className="home-page">
      ...
      <section className="home-intro" aria-labelledby="home-title">
        ...
        <div className="home-intro-copy">
          <p>
            Moodboard is a quiet, open canvas for collecting images, colors,
            notes, sounds, and links. Arrange references without forcing them
            into a template, then return when an idea needs direction.
          </p>
          <p>
            Try the canvas without an account and keep the demo in this browser,
            or sign in for persistent private boards that follow you across
            devices.
          </p>
        </div>
      </section>
      ...
      <section className="home-boards" aria-labelledby="boards-title">
        ...
        {!session.isPending && user === undefined && (
          <div className="home-board-message home-board-message--guest">
            <p>
              Start with an example board stored only in this browser. Signing
              in opens a separate private workspace.
            </p>
            <span>
              <Link to="/demo">Try the demo</Link>
              <Link
                to="/login"
                search={{ returnTo: boardPath(DEFAULT_BOARD_ID) }}
              >
      ...
      <footer className="home-acknowledgements">
        ...
        <div>
          <p>
            The canvas interaction and restraint were inspired by the mood page
            from Devouring Details: frameless media, free arrangement, and only
            the controls that need to be there.
          </p>
          <p>
            Built with React and Effect. Interface symbols are from Phosphor
            Icons. Moodboard is designed to stay portable, focused, and yours.
          </p>
        </div>
