...
const Reservation = Data.taggedEnum<ReservationResult>();
...
export class MediaRepo extends Context.Service<MediaRepo, MediaPersistence>()(
        ...
        return yield* sql.withTransaction(
          ...
          `;
            ...
            if (
              ...
              return Reservation.RequestLimit({
          ...
          `;
            ...
            if (
              ...
              return Reservation.StorageFull();
            }
