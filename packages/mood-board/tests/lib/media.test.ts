...
describe('managed media validation', () => {
  it('matches allowlisted MIME types to file signatures', () => {
    ...
    expect(normalizeMediaMimeType('audio', 'audio/mpeg; charset=binary')).toBe(
      'audio/mpeg',
    );
  });
