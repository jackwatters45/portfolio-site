...
describe('Better Auth', () => {
  it('creates a profile and session from a one-use magic link', async () => {
    ...
    const users = database
      .prepare('SELECT email, emailVerified FROM "user"')
      .all() as Array<{
      email: string;
