...
I would encourage anyone thinking about reading El Alquimista to take it for what it is: the tale of a shepard's journey from Andalusia to the Pyramids. Every novel has an underlying message but that doesn't mean it's value is entirely derived from it message. To write off El Alquimista as simply a self-help book is to write off a whole genre because you are unwilling to appreciate the story being told by it.
