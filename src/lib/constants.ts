	...
	recommend: [
		{
			...
			link:
				"https://www.goodreads.com/book/show/370523.Cien_a_os_de_soledad?from_search=true&from_srp=true&qid=9iOtGqU8Td&rank=1",
		...
		},
		{
			...
			link:
				"https://www.goodreads.com/book/show/28686959-based-on-a-true-story?from_search=true&from_srp=true&qid=ctedItGJ9l&rank=1",
			genre: "Memoir",
		},
		{
			name: "Notes From the Underground, The Double, and Other Stories",
			link:
				"https://www.goodreads.com/book/show/49961.Notes_from_Underground_The_Double_and_Other_Stories",
...
export const BUILDING: Building = {
	...
	past: [
		{
			name: "Team Send",
			description: "Informal Team Communication",
			year: 2023,
			link: "https://teamsend.yatusabes.co",
		},
		{
			name: "Local Finance",
			description: "Mindful Finance Tracking",
			year: 2024,
			link: "#",
		},
	],
...
export const LISTENING: Listening = {
	currently: [
		...
		},
		{
			...
			link:
				"https://open.spotify.com/artist/5R3NywPPOyhLfdvutgg0me?si=WwKqKLauQL65tFNJ1f1U5Q",
			genre: "Rock",
		},
	],
	"2024": [
		{
			name: "Deorro",
			link:
				"https://open.spotify.com/artist/6VD4UEUPvtsemqD3mmTqCR?si=LTO1Cl-IRgeO39kwazsobg",
			genre: "House",
		},
		{
			name: "Eladio Carrion",
